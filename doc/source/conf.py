# -*- coding: utf-8 -*-
#
# rhtlp documentation build configuration file, created by
...
project = u'rhtlp'
copyright = u'2010, Richard Murray, Necmiye Ozay, Ufuk Topcu, Nok Wongpiromsarn, Mumu Xu'
...
latex_documents = [
  ('index', 'rhtlp.tex', u'rhtlp Documentation',
...
man_pages = [
    ('index', 'rhtlp', u'rhtlp Documentation',
