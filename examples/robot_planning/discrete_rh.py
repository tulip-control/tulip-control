...
sys.atomic_propositions.add_from({'W0', 'W1','W2','W3','W4'})
sys.states.add('X0', ap={'W4'})
sys.states.add('X1', ap={'W3'})
sys.states.add('X2', ap={'W3'})
sys.states.add('X3', ap={'W2'})
sys.states.add('X4', ap={'W1'})
sys.states.add('X5', ap={'W1'})
sys.states.add('X6', ap={'W1'})
sys.states.add('X7', ap={'W1'})
sys.states.add('X8', ap={'W0'})

#Xor obs1 and obs2. Not allowed to change obs1 or obs2 when observe is set
env_vars = {'obs1','obs2'}
env_init = ''
env_prog = ''
env_safe = '(obs1||obs2)&&!(obs1&&obs2)&&((obs1&&observe)->X(obs1))&&((obs2&&observe)->X(obs2))'
...
sys_safe = '!(X6&&obs1)&&!(X7&&obs2)&&((X1||observe)<->X(observe))'
...
phi = '!X2&&(((W2||W1)&&observe)||!(W2||W1))&&(((X4||X6)&&!obs1)||!(X4||X6))&&(((X5||X7)&&!obs2)||!(X5||X7))'
