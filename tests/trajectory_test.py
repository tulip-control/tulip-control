# This test includes unit tests for the trajectory module.
#
# * trajectory_test(): a unit test for constructing a discrete time finite trajectory,
#   ensuring that all the getter functions return the correct values
# * concat_test(): a unit test for concatenating discrete time finite trajectories
