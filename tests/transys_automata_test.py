...
def rabin_test():
    ...
    assert(dra.states.accepting._pairs[0][0]._list == list())
    assert(dra.states.accepting._pairs[0][1]._set == {3,4} )
    assert(dra.states.accepting._pairs[0][1]._list == list())
    ...
    dra.states.accepting.add_states(0, [2], list())

    dra.states.accepting.add([2, 1], list())
    ...
    assert(dra.states.accepting._pairs[1][0]._list == list())
    assert(dra.states.accepting._pairs[1][1]._set == set() )
    assert(dra.states.accepting._pairs[1][1]._list == list())
